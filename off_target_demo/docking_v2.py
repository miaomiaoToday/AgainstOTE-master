...
class QVinaDockingTask(BaseDockingTask):
    ...
    @classmethod
    def from_generated_data_mod(cls, data, protein_root='./data/crossdocked', pock_id=0, out_ligand_receptor_list=None,
                                **kwargs):
    ...
    def __init__(self, pdb_block, ligand_rdmol, conda_env='adt', tmp_dir='./tmp', use_uff=True,
                 center=None):
